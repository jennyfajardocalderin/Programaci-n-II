...
public class Principal {
	...
	public static void main(String[] args) {
		...
		System.out.println(ds.getPersonal().size());
		...
		System.out.println();
		System.out.println("------------------Misiones ordenadas por coste--------------");
		ArrayList<Mision> misionesOrd = ds.getMisiones();
		Collections.sort(misionesOrd);
		for(Mision mi : misionesOrd) {
